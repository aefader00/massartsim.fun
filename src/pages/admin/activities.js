...
// Import styles.
import styles from "../../../styles/pages/admin/activities.module.css";
  ...
  return (
    <div>
      ...
      <div className={styles.blurb}>
        ...
        <p>Click on an Activity to edit/delete it.</p>
      </div>
      {/* Render the button that links to the editing interface. */}
      <div style={{ textAlign: "center", margin: "1rem" }}>
        <Link href="/admin/updateActivity?action=insert">
          <a>
            <div className={styles.participate}>
              Click here to insert an Activity.
            </div>
          </a>
        </Link>
      </div>
      ...
      <div style={{ textAlign: "center", margin: "1rem" }}>
        ...
        <Listbox
          ...
          onChange={(value) => {
            router.push(`/admin/activities/?week=${value}`);
          }}
        >
  ...
  if (
    ...
    return (
      <Activity
        ...
        producers={producers}
        faculty={faculty}
        link={`/admin/updateActivity?action=update&id=${id}`}
      />
    );
  }
}
